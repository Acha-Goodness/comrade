        ...
        <View className="bg-white mx-[5%] rounded-[24px] p-6 mt-4 flex-1 min-h-[500px] relative shadow-sm">
            ...
            <View className="items-center justify-center flex-1 mt-10">
                <View className="w-24 h-24 rounded-full bg-[#FAF5FF] items-center justify-center mb-6">
                    <Ionicons name="folder" size={48} color="#240046" />
                </View>
                <Text className="text-[16px] font-[600] text-[#000] mb-2 text-center">No completed Ajo yet.</Text>
                <Text className="text-[12px] text-[#666] text-center">All completed ajo will appear here.</Text>
            </View>
            ...
            <View className="absolute bottom-6 right-6">
                ...
                >
                    ...
                    <Text className="text-[#240046] text-[14px] font-[600]">Find an Ajo</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
